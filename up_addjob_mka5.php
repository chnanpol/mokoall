 ...
 <th>   <center> แนวทางชดเชย </th> </center>
	...
	<tr>
		<td>
			<div class="form-group">
                <label class="form-text"></label>
				<textarea id="Topics_covered" name="Topics_covered" class="form-control" ><?php echo $rowpro['Topics_covered']; ?>   </textarea>
        ...
        <td>
			<div class="form-group">
                <label class="form-text"></label>
				<textarea id="Significance " name="Significance" class="form-control" ><?php echo $rowpro['Significance']; ?>   </textarea>
        ...
        <td>
			<div class="form-group">
                <label class="form-text"></label>
				<textarea id="Compensation" name="Compensation" class="form-control" ><?php echo $rowpro['Compensation']; ?>   </textarea>
...
<label class="form-text"> </label>
 ...
 <label class="form-text"> ข้อเสนอการดำเนินการเพื่อปรับปรุงวิธีสอน (ซึ่งได้จากปัญหาที่พบในข้อ 2.3) </label>
              <textarea id="Improveteaching" name="Improveteaching" class="form-control"> <?php echo $rowpro['Improveteaching']; ?></textarea> 
                </div>
...
<br>
 ...
 <label class="form-text"> 1. จำนวนนักศึกษาที่ลงทะเบียนเรียน</label>
              <input id="students_enrolled " name="students_enrolled" class="form-control" type="number "value="<?php echo $rowpro['students_enrolled']; ?>"> 
    </div>
    
 <div class="col-12">
 <label class="form-text"> 2. จำนวนนักศึกษาที่คงอยู่เมื่อสิ้นสุดภาคการศึกษา  </label>
              <input id="students_remaining " name="students_remaining" class="form-control"  type="number "value="<?php echo $rowpro['students_remaining']; ?>"> 
    </div>
    
 <div class="col-12">
 <label class="form-text">3. จำนวนนักศึกษาที่ถอน (W) </label>
              <input id="students_withdrawn" name="students_withdrawn" class="form-control"  type="number "value="<?php echo $rowpro['students_withdrawn']; ?>"> 
    </div>
 ...
 <th>   <center> คิดเป็นร้อยละ </th> </center>
	...
	<tr>
		<td>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="a" name="a" class="form-control"value="<?php echo $rowpro['A']; ?>" > 
                </div>
			
			<div class="form-group">
                <label class="form-text"></label>
				<input id="bp" name="bp" class="form-control"value="<?php echo $rowpro['BP']; ?>" > 
                
                </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="b" name="b" class="form-control"value="<?php echo $rowpro['B']; ?>" > 

                	 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="cp" name="cp" class="form-control"value="<?php echo $rowpro['CP']; ?>" > 

                	 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="c" name="c" class="form-control"value="<?php echo $rowpro['C']; ?>" > 

                	 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="dp" name="dp" class="form-control"value="<?php echo $rowpro['DP']; ?>" > 

                	 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="d" name="d" class="form-control"value="<?php echo $rowpro['D']; ?>" > 

                	 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="f" name="f" class="form-control"value="<?php echo $rowpro['F']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="x" name="x" class="form-control"value="<?php echo $rowpro['X']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="w" name="w" class="form-control"value="<?php echo $rowpro['W']; ?>" > 
          </div>
		</td>		
        ...
        <td>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="a1" name="a1" class="form-control"value="<?php echo $rowpro['A1']; ?>" > 

			 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="bp1" name="bp1" class="form-control"value="<?php echo $rowpro['BP1']; ?>" > 
                
                </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="b1" name="b1" class="form-control"value="<?php echo $rowpro['B1']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="cp1" name="cp1" class="form-control"value="<?php echo $rowpro['CP1']; ?>" > 

                 </div>	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="c1" name="c1" class="form-control"value="<?php echo $rowpro['C1']; ?>" > 

                	 </div>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="dp1" name="dp1" class="form-control"value="<?php echo $rowpro['DP1']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="d1" name="d1" class="form-control"value="<?php echo $rowpro['D1']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="f1" name="f1" class="form-control"value="<?php echo $rowpro['F1']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="x1" name="x1" class="form-control"value="<?php echo $rowpro['X1']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="w1" name="w1" class="form-control"value="<?php echo $rowpro['W1']; ?>" > 
          </div>
		</td>
    	<td>
			<div class="form-group">
                <label class="form-text"></label>
				<input id="a2" name="a2" class="form-control"value="<?php echo $rowpro['A2']; ?>" > 
                </div>
			
			<div class="form-group">
                <label class="form-text"></label>
				<input id="bp2" name="bp2" class="form-control"value="<?php echo $rowpro['BP2']; ?>" > 
                </div>
                
			<div class="form-group">
                <label class="form-text"></label>
				<input id="b2" name="b2" class="form-control"value="<?php echo $rowpro['B2']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="cp2" name="cp2" class="form-control"value="<?php echo $rowpro['CP2']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="c2" name="c2" class="form-control"value="<?php echo $rowpro['C']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="dp2" name="dp2" class="form-control"value="<?php echo $rowpro['DP2']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="d2" name="d2" class="form-control"value="<?php echo $rowpro['D2']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="f2" name="f2" class="form-control"value="<?php echo $rowpro['F2']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="x2" name="x2" class="form-control"value="<?php echo $rowpro['X2']; ?>" > 
                </div>
                	
			<div class="form-group">
                <label class="form-text"></label>
				<input id="w2" name="w2" class="form-control"value="<?php echo $rowpro['W2']; ?>" > 
          </div>
		</td>
	</tr> 
...
<div class="col-12">
 <label class="form-text">  ปัจจัยที่ทำให้ระดับคะแนนผิดปกติ (ถ้ามี) </label>
              <textarea id="Factors_to_Rating" name="Factors_to_Rating" class="form-control">  <?php echo $rowpro['Factors_to_Rating']; ?></textarea> 
    </div>

<div class="col-12">
 <label class="form-text">  ความคลาดเคลื่อนจากแผนการประเมินที่กำหนดไว้ในรายละเอียดรายวิชา </label>
              <textarea id="assessment" name="assessment" class="form-control">  <?php echo $rowpro['assessment']; ?></textarea> 
    </div>

    <div class="col-12">
 <label class="form-text"> ความคลาดเคลื่อนด้านกำหนดเวลาการประเมิน </label>
              <textarea id="Time_deviation " name="Time_deviation" class="form-control"> <?php echo $rowpro['Time_deviation']; ?></textarea> 
    </div>

    <div class="col-12">
 <label class="form-text">  ความคลาดเคลื่อนด้านวิธีการประเมินผลการเรียนรู้ (ถ้ามี) </label>
              <textarea id="Discrepancies " name="Discrepancies" class="form-control"> <?php echo $rowpro['Discrepancies']; ?></textarea> 
    </div>
    <br>
...
<div class="col-12">
 <label class="form-text">  วิธีการทดสอบ </label>
              <textarea id="Verification_method" name="Verification_method" class="form-control"> <?php echo $rowpro['Verificatio_method']; ?></textarea>
    </div>

<div class="col-12">
 <label class="form-text">  สรุปผล</label>
              <textarea id="conclude" name="conclude" class="form-control"><?php echo $rowpro['conclude']; ?></textarea>
    </div>
    <br>
...
<div class="col-12">
 <label class="form-text">  ปัญหาในการใช้แหล่งทรัพยากรประกอบการเรียนการสอน (ถ้ามี)</label>
              <textarea id=" problem_of_using" name=" problem_of_using" class="form-control"> <?php echo $rowpro['problem_of_using']; ?></textarea>
    </div>  
...
<div class="col-12">
 <label class="form-text">   ผลกระทบ </label>
              <textarea id=" effect" name=" effect" class="form-control"> <?php echo $rowpro['effect']; ?></textarea>
 ...
 <label class="form-text">  ปัญหาด้านการบริหารและองค์กร (ถ้ามี)  </label>
              <textarea id="Administrative" name="Administrative" class="form-control"><?php echo $rowpro['Administrative']; ?></textarea>

    </div>  
      
    <div class="col-12">
 <label class="form-text">  ผลกระทบต่อผลการเรียนรู้ของนักศึกษา </label>
              <textarea id="Impact" name="Impact" class="form-control"><?php echo $rowpro['Impact']; ?></textarea>
              </div>
              <br>
...
<div class="col-12">
 <label class="form-text">   ผลการประเมินรายวิชาโดยนักศึกษา (แนบเอกสาร)  </label>
              <textarea id=" Student_Evaluation " name=" Student_Evaluation" class="form-control"> <?php echo $rowpro['Student_Evaluation']; ?></textarea>
    </div>  


<div class="col-12">
 <label class="form-text">   ข้อวิพากษ์ที่สำคัญจากผลการประเมินโดยนักศึกษา  </label>
              <textarea id=" Critical" name=" Critical" class="form-control"><?php echo $rowpro['Critical']; ?></textarea>
    </div>  


<div class="col-12">
 <label class="form-text">   ความเห็นของอาจารย์ผู้สอนต่อข้อวิพากษ์ตามข้อ   </label>
              <textarea id=" comments" name=" comments" class="form-control"><?php echo $rowpro['comments']; ?></textarea>
    </div>  
...
<div class="col-12">
 <label class="form-text">  ข้อวิพากษ์ที่สำคัญจากผลการประเมินโดยคณะกรรมการ   </label>
              <textarea id=" Critical_1 " name=" Critical_1" class="form-control"><?php echo $rowpro['Critical_1']; ?></textarea>
    </div>  

<div class="col-12">
 <label class="form-text">   ความเห็นของอาจารย์ผู้สอนต่อข้อวิพากษ์ตามข้อ   </label>
              <textarea id=" comments_1 " name=" comments_1" class="form-control"><?php echo $rowpro['comments_1']; ?></textarea>
    </div> 
      <hr>
<br>
...
<div class="col-12">
 <label class="form-text">   แผนการปรับปรุงที่เสนอในภาคการศึกษา / ปีการศึกษาที่ผ่านมา             </label>
              <textarea id=" Improvement" name="Improvement" class="form-control"><?php echo $rowpro['Improvement']; ?></textarea>
    </div> 
    <div class="col-12">
 <label class="form-text">   ผลการดำเนินการ </label>
              <textarea id="Results " name="Results" class="form-control"><?php echo $rowpro['Results']; ?> </textarea>
    </div> 
    <div class="col-12">
 <label class="form-text">   การดำเนินการอื่นๆ ในการปรับปรุงรายวิชา  </label>
              <textarea id=" Other_actions " name="Other_actions" class="form-control"><?php echo $rowpro['Other_actions']; ?></textarea>
    </div> 
    <br>
 ...
 <label class="form-text">   ข้อเสนอ  </label>
              <textarea id=" offer " name="offer" class="form-control"><?php echo $rowpro['offer']; ?> </textarea>
    </div> 
   
    <div class="col-12">
 <label class="form-text"> กำหนดเวลาที่แล้วเสร็จ</label>
              <textarea id="Time_limit" name="Time_limit" class="form-control"><?php echo $rowpro['Time_limit']; ?></textarea>
    </div> 
    <div class="col-12">
 <label class="form-text">  ผู้รับผิดชอบ  </label>
              <textarea id="responsible_person" name="responsible_person" class="form-control"><?php echo $rowpro['responsible_person']; ?></textarea>
    </div> 
    <div class="col-12">
 <label class="form-text">ข้อเสนอแนะของอาจารย์ผู้รับผิดชอบรายวิชาต่ออาจารย์ผู้รับผิดชอบหลักสูตร  </label>
              <textarea id=" Suggestions " name="Suggestions" class="form-control"><?php echo $rowpro['Suggestions']; ?> </textarea>
    </div> 
